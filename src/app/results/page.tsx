      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <CardSpotlight className="p3r-card p-5">
          ...
          {knapsackResult.excludedItems.length === 0 ? (
            ...
            <p className="font-mono text-xs text-[#4488DD]">All items were selected — perfect fit!</p>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        {[
          ...
          { label: "Top Priority Item", value: topsisResults[0]?.item.name.substring(0, 12) + (topsisResults[0]?.item.name.length > 12 ? "..." : ""), unit: `CC: ${topsisResults[0]?.closenessCoefficient.toFixed(4)}`, color: "text-[#ffd700]", border: "border-yellow-400/30" },
